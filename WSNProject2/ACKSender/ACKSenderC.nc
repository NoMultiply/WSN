...
implementation {
  ...
  event message_t* Receive.receive(message_t* msg, void* payload, uint8_t len) {
		//if(len == sizeof(ResultMsg) && call AMPacket.source(msg) == 10 && call AMPacket.destination(msg) == 0) {
    if(len == sizeof(ResultMsg)) {
			ResultMsg* recv_pkt = (ResultMsg*)payload;
			ack_msg_t* this_pkt = (ack_msg_t*)(call Packet.getPayload(&pkt, sizeof(ResultMsg)));
